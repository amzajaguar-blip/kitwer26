...
// Static date — avoids false "modified" signals on every crawl request.
// Update this manually after a content or layout change.
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  if (!supabaseUrl || !supabaseKey) {
    return [...STATIC_PAGES, ...BUNDLE_PAGES];
  }
  ...
  return [...STATIC_PAGES, ...BUNDLE_PAGES, ...productPages];
}
