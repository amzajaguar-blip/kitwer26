...
export const SUB_CATEGORIES: Record<string, { id: string; label: string; slug: string }[]> = {
  'Crypto Wallets': [
    ...
    { id: 'rfid-faraday', label: 'RFID & Faraday', slug: 'rfid-faraday' },
  ...
  'Cyber Security': [
    ...
    { id: 'surveillance-legal', label: 'Sorveglianza',       slug: 'surveillance-legal' },
    { id: 'sdr-rf',             label: 'SDR & RF',           slug: 'sdr-rf' },
    { id: 'rfid-nfc',           label: 'RFID & NFC',         slug: 'rfid-nfc' },
    { id: 'pentest-hardware',   label: 'Pentest Hardware',   slug: 'pentest-hardware' },
    { id: 'encrypted-storage',  label: 'Encrypted Storage',  slug: 'encrypted-storage' },
    { id: 'general',            label: 'General',            slug: 'general' },
  ],
  'Sim Racing': [
